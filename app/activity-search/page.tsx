  ...
  const activities: Activity[] = [
    {
      ...
      groupSize: "Up to 20",
      description:
        "Skip the crowds and explore the iconic Eiffel Tower with expert guide",
    },
    {
      id: 2,
      ...
      groupSize: "Up to 12",
      description:
        "Experience breathtaking sunrise views from Mount Batur volcano",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      groupSize: "Up to 30",
      description:
        "Thrilling desert adventure with dune bashing and camel riding",
    },
    {
      id: 5,
    ...
    },
    {
      ...
      groupSize: "Up to 4",
      description:
        "Soar above the stunning Swiss Alps with professional instructors",
    },
  ];
